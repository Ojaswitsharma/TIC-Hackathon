...
try:
    ...
    print("pip install openai-whisper langgraph sounddevice pyaudio pyttsx3")
...
def main():
    ...
    if not CONVERSATIONAL_AVAILABLE:
        ...
        print("Please install: pip install openai-whisper langgraph sounddevice pyaudio pyttsx3")
        return
    
    # Check for required API keys (Whisper doesn't need an API key)
